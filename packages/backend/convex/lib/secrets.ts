...
// Takes a secret from AWS → tries to convert it from string → into JSON object. If any step fails, it returns null. This is useful for safely retrieving secrets that are stored as JSON strings in AWS Secrets Manager.
